...
public class AlertsAlert {
   ...
   * @return headline
  **/
  @Schema(example = "NWS New York City - Upton (Long Island and New York City)", description = "")
  ...
  **/
   ...
   * @return category
  **/
  @Schema(example = "Extreme temperature value", description = "")
  ...
  **/
   ...
   * @return event
  **/
  @Schema(example = "Heat Advisory", description = "")
  ...
  **/
   ...
   * @return effective
  **/
  @Schema(example = "2022-07-21T19:38Z", description = "")
   ...
   * @return expires
  **/
  @Schema(example = "2022-07-25T00:00Z", description = "")
